...
import (
	...
	sqlc "github.com/Sushka21/microservices-ecommerce/notifications/internal/repository/inbox/sqlc"
...
func (o *inboxRepository) getQueries(ctx context.Context) sqlc.Querier {
...
func (o *inboxRepository) SendMessage(
	ctx context.Context,
...
func (o *inboxRepository) GetMessages(
	ctx context.Context,
	batchSize int,
...
func (o *inboxRepository) MarkAsProcessed(ctx context.Context, idempotencyKeys []string) error {
...
func (o *inboxRepository) MarkAsRetryable(ctx context.Context, idempotencyKeys []string) error {
	if len(idempotencyKeys) == 0 {
		return nil
	}
	queries := o.getQueries(ctx)
